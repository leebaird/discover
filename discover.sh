...
s/UKRAINE/Ukraine/g; s/UNITED KINGDOM/United Kingdom/g; s/UNITED STATES/United States/g; s/VIRGIN ISLANDS (BRITISH)/Virgin Islands/g' tmp4 > squatting
     ...
     sleep 1
     firefox -new-tab crunchbase.com/organization/$company &
     sleep 1
...
s/MULTI/Multi/g; s/music/Music/g; s/MyHR/HR/g; s/Myrtle Beach//g; s/National City//g; s/Naval Anaco//g; s/Needham Hei//g; s/negotiator/Negotiator/g; s/New Castle//g; s/New Church//g; 
...
s/Monterey$//g; s/Montezuma$//g; s/Montgomery$//g; s/Montoursville$//g; s/Montreal$//g; s/Montvale$//g; s/Moorestown$//g; s/Mooresville$//g; s/Morgantown$//g; s/Morristown$//g; 
s/Morrisville$//g; s/Moscow$//g; s/Mumbai$//g; s/Mundelein$//g; s/Murdock$//g; s/Murfreesboro$//g; s/Murrysville$//g; s/Muskegon$//g; s/Mystic$//g; s/Naperville$//g; s/Naples$//g; 
