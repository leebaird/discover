...
sleep 1
iceweasel -new-tab http://www.advancedbackgroundchecks.com/search/results.aspx?type=&fn=$firstName&mi=&ln=$lastName&age=&city=&state=
sleep 1
iceweasel -new-tab http://www.cvgadget.com/person/$firstName/$lastName &
sleep 1
iceweasel -new-tab http://www.peekyou.com/$firstName_$lastName &
sleep 1
