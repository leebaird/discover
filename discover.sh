...
s/commercial/Commercial/g; s/connected/Connected/g; s/CONSULTANT/Consultant/g; s/Consultant-ii/Consultant II/g; s/consumer/Consumer/g; s/contact/Contact/g; s/content/Content/g; 
s/corporate/Corporate/g; s/Corpus Christi//g; s/Council Bluffs//g; s/COUNSEL/Counsel/g; s/counsel/Counsel/g; s/Cranberry T//g; s/Cranberry Twp//g; s/credit/Credit/g; s/CREDIT/Credit/g; 
s/Crm/CRM/g; s/Croton On H//g; s/Cross Junction//g; s/Crum Lynne//g; s/Crystal Lake//g; s/Ctr/Center/g; s/Culver City//g; s/Cuyahoga Falls//g; s/Daly City//g; s/database/Database/g; 
s/dealer/Dealer/g; s/defense/Defense/g; s/DELIVERY/Delivery/g; s/Del Mar//g; s/Delray Beach//g; s/Deer Park//g; s/Del Rio//g; s/DEPUTY/Deputy/g; s/West Des Mo//g; s/Des Moines//g; 
s/Des Plaines//g; s/DesignatedFederalOfficial/Designated Federal Official/g; s/DESIGNER/Designer/g; s/DESIGN/Design/g; s/development/Development/g; s/DEVICES/Devices/g; 
s/Diamond Bar//g; s/director/Director/g; s/DISCIPLINED/Disciplined/g; s/discovery/Discovery/g; s/display/Display/g; s/Dns/DNS/g; s/Downers Grove//g; s/Drexel Hill//g; s/Du Bois//g; 
...
s/East Stroud//g; s/East Syracuse//g; s/eastern Region//g; s/Eau Claire//g; s/Eden Prairie//g; s/education/Education/g; s/Egg Harbor//g; s/Egg Harbor//g; s/El Cajon//g; s/El Centro//g; 
s/El Monte//g; s/El Paso//g; s/El Segundo//g; s/ELECTRIC/Electric /g; s/ELECTRONICS/Electronics/g; s/Port Elizabeth//g; s/Elk Grove V//g; s/Elk Grove//g; s/Ellicott City//g; 
s/Elk Grove V//g; s/Elkhart//g; s/Elm Grove//g; s/emerging/Emerging/g; s/endocrinology/Endocrinology/g; s/ENERGY/Energy/g; s/energy/Energy/g; s/engineer/Engineer/g; 
...
s/Falls Church//g; s/Farmington Hls//g; s/fashion/Fashion/g; s/federal/Federal/g; s/FELLOW/Fellow/g; s/Fha/FHA/g; s/FIELD/Field/g; s/fillmore/Fillmore/g; s/financial/Financial/g; 
s/Flat Rock//g; s/FLIGHT/Flight/g; s/Florham Park//g; s/Flower Mound//g; s/Floyds Knobs//g; s/for Asia and//g; s/for The Sds Contract //g; s/Forest Hills//g; s/Forest Hill//g; 
...
s/Glen Ellyn//g;  s/Glen Ridge//g; s/Glen Rock//g; s/global/Global/g; s/-go Team//g; s/A Google Company//g; s/Google Access//g; s/Google Adwords//g; s/Google Analytics//g; 
s/Google Books//g; 
