...
s/East Syracuse$//g; s/East Weymouth$//g; s/South Easton$//g; s/Easton$//g; s/Eatonton$//g; s/Eatontown$//g; s/Eau Claire$//g; s/Eden Prairie$//g; 
...
s/academic/Academic/i; s/account/Account/i; s/acting/Acting/i; s/Admin Manager/Manager, Admin/i; s/admin/Admin/i; s/adviso /Advisor/i; 
s/analysist/Analysist/i; s/analytics/Analytics/i; s/android/Android/i; s/applications/Applications/i; s/area iii manager/Manager, Area III/i; 
s/ asic/ ASIC/i; s/assistant/Assistant/i; s/AssistantChiefPatrolAgent/Assistant Chief Patrol Agent/g; s/associate /Associate, /i; s/ at $//g; 
s/atm /ATM /i; s/attorney/Attorney/i; s/automated/Automated/i; s/\-b/, B/i; s/banking/Banking/i; s/bd/BD/i; s/benefits manager/Manager, Benefits/i; 
s/billing manager/Manager, Billing/i; s/billing/Billing/i; s/border/Border/i; s/branch/Branch/i; s/brach/Branch/i; s/bsc/BSC/i; s/business/Business/i; 
s/buyer/Buyer/i; s/\-c/, C/i; s/cargo/Cargo/i; s/cascade/Cascade/i; s/cbt/CBT/i; s/census/Census/i; s/center/Center/i; s/chemicals/Chemicals/i; 
s/chemist/Chemist/i; s/chromecast/Chromecast/i; s/ cip / CIP /i; s/cissp/CISSP/i; s/citrix/Citrix/i; s/civil/Civil/i; s/cj/CJ/i; 
s/Claims Manager/Manager, Claims/i; s/clean/Clean/i; s/Clients//g; s/cmms/CMMS/i; s/cms/CMS/i; s/commercial/Commercial/i; s/commission/Commission/i; 
s/CommitteemanagementOfficer/Committee Management Officer/g; s/communications manager/Manager, Communications/i; s/community/Community/i;
s/compliance manager/Manager, Compliance/i; s/compliance/Compliance/i; s/connected/Connected/i; s/consolidation/Consolidation/i; 
...
s/content/Content/i; s/corporate equipment reliability manager/Manager, Corporate Equipment Reliability/i; 
...
s/customer account manager/Manager, Customer Account/i; s/\-d/, D/i; s/database/Database/i; s/data processing manager/Manager, Data Processing/i; 
s/db2/DB2/i; s/dbii/DB2/i; s/dealer/Dealer/i; s/defense/Defense/i; s/delivery/Delivery/i; s/deputy/Deputy/i; 
s/DesignatedFederalOfficial/Designated Federal Official/g; s/designer/Designer/i; s/design/Design/i; s/development/Development/i; s/devices/Devices/i; 
s/director/Director/i; s/director-/Director, /i; s/director and/Director,/i; s/director in/Director,/i; s/director of/Director,/i; 
...
s/display/Display/i; s/dist polcy manager/Manager, Dist Polcy/i; s/dns/DNS/i; s/dvp/DVP/i; s/\-e/, E/i; s/ ebs/ EBS/i; s/echnical /Technical /i; 
...
s/EleCenterEngineer/Electric Engineer/i; s/electronics/Electronics/i; s/emc/EMC/i; s/emea/EMEA/i; s/emerging/Emerging/i; s/employee/Employee/i; 
s/ ems/ EMS/i; s/endocrinology/Endocrinology/i; s/energy consulting manager/Manager, Energy Consulting/i; s/energy/Energy/i; 
s/engineering manager/Manager, Engineering/i; s/engineer/Engineer/i; s/engineer5/Engineer V/i; s/enterprise/Enterprise/i; 
...
s/,formation/, Formation/i;  s/fsa/FSA/i; s/fso/FSO/i; s/FUNCTIONLead/Function Lead/g; s/fx/FX/i; s/\-g/, G/i; s/gaap/GAAP/i; 
s/gas projects manager/Manager, Gas Projects/i; s/generation project manager/Manager, Generation Project/i; s/gis services/GIS Services/i; 
s/Global Bi Reporting Manager/Manager, Global Bi Reporting/i; s/global/Global/i; s/group/Group/i; s/grp/Group/i; s/gsa/GSA/i; s/gsis/GSIS/i; s/gsm/GSM/i; 
s/\-h/, H/i; s/hazard/Hazard/i; s/hd manager/Manager, HD/i; s/hd/HD/i; s/hmrc/HMRC/i; s/hp/HP/i; s/hq/HQ/i; 
s/Human Resources Benefits Director/Director, Human Resources Benefits/i; s/Human Resources Manager/Manager, Human Resources/i; s/\-i/, I/i; 
s/ id / ID /i; s/iii/III/i; s/ii/II/i; s/improvement/Improvement/i; s/import /Import /i; s/information/Information/i; s/information technology/IT/i; 
...
s/intelligence/Intelligence/i; s/international/International/i; s/investor/Investor/i; s/ir manager/IR Manager/i; s/issm/ISSM/i; 
...
s/maintenance manager/Manager, Maintenance/i; s/manager /Manager, /i; s/maintenance/Maintenance/i; s/management-/Management,/i; s/mangr/Manager/i; 
s/Manager- /Manager, /i; s/manager, and/Manager, /i; s/Manager, for/Manager,/i; s/manager, of /Manager, /i; s/manufacturing/Manufacturing/i; 
...
s/operations supervisor/Supervisor, Operations/i; s/operations/Operations/i; s/oriented/Oriented/i; s/\-p/, P/i; s/packaging/Packaging/i; 
s/paralegal/Paralegal/i; s/parent/Parent/i; s/patrol/Patrol/i; s/payments/Payments/i; s/pca/PCA/i; s/pc/PC/i; s/pdm/PDM/i; s/phd/PhD/i; 
s/physical/Physical/i; s/pj/PJ/i; s/planner/Planner/i; s/planning/Planning/i; s/platform/Platform/i; s/plt/Plant/i; s/pmo/PMO/i; s/pmp/PMP/i; 
s/pm /PM /i; s/portdirector/Port Director/i; s/portfolio/Portfolio/i; s/power contracts manager/Manager, Power Contracts/i; 
s/power projects manager/Manager, Power Projects/i; s/power/Power/i; s/pre, sales/Pre Sales/i; s/premium/Premium/i; s/president/President/i; 
s/president and/President,/i; s/president of/President,/i; s/president /President, /i; s/prevention/Prevention/i; s/principal/Principal/i; 
s/principal and/Principal,/i; s/principal of/Principal,/i; s/private/Private/i; s/process/Process/i; s/procurement/Procurement/i; s/producer/Producer/i; 
s/product support manager/Manager, Product Support/i; s/production/Production/i; s/programming/Programming/i; s/program/Program/i; s/project/Project/i; 
s/Purchasing Manager/Manager, Purchasing/i; s/purchase/Purchase/i; s/\-q/, Q/i; s/\-r/, R/i; s/radiology/Radiology/i; s/r and d/R&D/i; 
s/receives/Receives/i; s/recreation/Recreation/i; s/Regional Production Director/Director, Regional Sales/i; s/regional/Regional/i; s/regular/Regular/i; 
s/regulatory litigation case manager/Manager, Regulatory Litigation Case/i; s/relationship/Relationship/i; s/reliability/Reliability/i; 
s/retail/Retail/i; s/retirement/Retirement/i; s/revenue/Revenue/i; s/rfid/RFID/i; s/rfp/RFP/i; s/ rf/ RF/i; s/right of way/Right of Way/i; s/risk/Risk/i; 
s/\-s/, S/i; s/safety manager/Manager, Safety/i; s/safety/Safety/i; s/Sales Director/Director, Sales/i; s/sales manager/Manager, Sales/i; 
s/sales/Sales/i; s/san manager/SAN Manager/i; s/scada/SCADA/i; s/scholar/Scholar/i; s/scientist/Scientist/i; 
s/scm site supervisor/Supervisor, SCM Site/i; s/security compliance manager/Manager, Security Compliance/i; s/security/Security/i; 
...
s/srbranch/Senior Branch/i; s/srsales/Senior Sales/i; s/ssl/SSL/i; s/staffing/Staffing/i; s/stf/Staff/i; s/stock/Stock/i; s/strategic/Strategic/i; 
s/subsidiary/Subsidiary/i; s/supervisor /Supervisor, /i; s/Supervisor, and/Supervisor,/i; s/supervisor, of/Supervisor,/i; 
s/supply chain manager/Manager, Supply Chain/i; s/supply/Supply/i; s/support/Support/i; s/swepco/SWEPCO/i; s/\-t/, T/i; s/teacher/Teacher/i; 
s/ team/ Team/i; s/Technical Manager/Manager, Technical/i; s/technical/Technical/i; s/technologymanager/Technology Manager/i; s/technology/Technology/i; 
s/ttechnical/Technical/i; s/tech/Tech/i; s/telecommunications/Telecommunications/i; s/television/Television/i; s/testing/Testing/i; s/test/Test/i; 
s/the /the /i; s/trademarks/Trademarks/i; s/ to .*$//i; s/trainer/Trainer/i; s/training manager/Manager, Training/i; 
