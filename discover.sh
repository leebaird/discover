...
case $choice in
     ...
     sed '/[[:blank:]]/!d' tmp6 > tmp7
     # Clean up
     egrep -v '(~|`|!|@|#|\$|%|\^|&|\*|\(|\)|_|-|\+|=|{|\[|}|]|\|:|;|"|<|>|\.|\?|/|abuse|academy|account|achievement|action|active|adjuster|admin|advanced|adventure|advertising|alliance|allstate|ambassador|america|american|analysis|analyst|analytics|antivirus|apple seems|application|applications|architect|article|assembler|assembling|assembly|asian|assignment|assistant|associate|association|attorney|auditor|australia|automation|automotive|balance|bank|bbc|beginning|berlin|beta theta|between|big game|billion|bioimages|biometrics|bizspark|breaches|broker|business|buyer|buying|california|cannot|capital|career|carrying|cashing|center|certified|cfi|challenger|championship|change|chapter|charge|china|chinese|claim|clearance|cloud|code|college|columbia|commercial|communications|community|company pages|competition|competitive|compliance|computer|concept|conference|config|connections|connect|construction|consultant|contract|contributor|controllang|cooperation|coordinator|corporate|corporation|counsel|creative|critical|croatia|crm|dallas|day care|death toll|delta|department|description|designer|design|detection|developer|develop|development|devine|dialysis|digital|diploma|director|disability|disaster|disclosure|dispute|division|dns|document|dos poc|download|drivers|during|economy|ecovillage|editor|education|effect|electronic|else|emails|embargo|emerging|empower|employment|end user|energy|engineer|enterprise|entertainment|entreprises|entrepreneur|entry|environmental|error page|ethical|example|excellence|executive|expertzone|exploit|facebook|faculty|failure|fall edition|fast track|fatherhood|fbi|federal|filmmaker|finance|financial|forensic|forklift|found|freelance|from|frontiers in tax|full|function|fuzzing|germany|get control|global|google|governance|government|graphic|greater|group|guardian|hackers|hacking|harden|harder|hawaii|hazing|headquarters|health|help|history|homepage|hospital|hostmaster|house|how to|hurricane|icmp|idc|in the news|index|inform|innovation|installation|insurers|integrated|international|internet|instructor|insurance|intelligence|interested|investigation|investment|investor|israel|items|japan|job|justice|kelowna|knowing|laptops|leader|letter|liaison|licensing|lighting|linkedin|limitless|liveedu|llp|local|looking|lpn|ltd|lsu|luscous|macys|malware|managed|management|manager|managing|manufacturing|market|mastering|maturity|md|media|medical|medicine|member|meta tags|methane|metro|microsoft|middle east|mission|mitigation|mn|money|monitor|more coming|mortgage|museums|mutual|negative|network|network|new user|newspaper|new york|next page|nitrogen|nw|nyc|obtain|occupied|offers|office|online|operations|operator|organizational|outbreak|owner|page|partner|pathology|peace|people|perceptions|philippines|photo|picture|places|planning|portfolio|potential|preassigned|preparatory|president|principal|print|private|process|producer|product|professional|professor|profile|project|program|publichealth|published|pyramid|questions|rcg|recruiter|redeem|redirect|region|register|registry|regulation|rehab|remote|report|representative|republic|research|resolving|restaurant|revised|rising|rural health|russia|sales|satellite|save the date|school|scheduling|science|scientist|search|searc|sections|secured|security|secretary|secrets|see more|selection|senior|server|service|services|social|software|solutions|source|special|station home|statistics|strategy|student|study|substitute|successful|superheroines|supervisor|support|switch|system|systems|talent|targeted|tax|tcp|teacher|technical|technician|technology|temporary|tester|textoverflow|theater|thought|time in|tit for tat|title|toolbook|tools|toxic|traditions|trafficking|transfer|transformation|treasury|trojan|twitter|training|ts|tylenol|types of scams|unclaimed|underground|underwriter|university|united states|untitled|vault|verification|vietnam|view|Violent|virginia bar|voice|volkswagen|volume|vp|wanted|web search|web site|website|welcome|west virginia|westchester|when the|whiskey|window|worker|world|www|xbox)' tmp7 > tmp8
...
grep '/' tmp | awk '{print $1}' | egrep -iv '(adobe|bozocrack|brute_suffix|cache_snoop|dev_diver|exploitation|freegeoip|gists_search|github_commits|github_dorks|github_users|google_site_web|hashes_org|import|interesting_files|jigsaw|linkedin_auth|locations|mailtester|mangle|metacrawler|migrate_contacts|migrate_hosts|namechk|profiler|pwnedlist|reporting|vulnerabilities)' > tmp2
