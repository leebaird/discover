...
s/VIRGIN ISLANDS (BRITISH)/Virgin Islands/g' tmp4 > squatting
     ...
     if [ -f /$user/data/$domain/data/subdomains.htm ]; then
     ...
     if [[ -f /$user/data/$domain/data/emails.htm && -f emails ]]; then
...
s/Findlay//g; s/Fishers//g; s/Flat Rock//g; s/Flemington//g; s/Florence//g; s/Floresville//g; s/Florham Park//g; s/Flossmoor//g; s/Flourtown//g; 
s/Flower Mound//g; s/Flowood//g; s/Floyds Knobs//g; s/Fogelsville//g; s/Forest Hill//g; s/Forked River//g; s/foreign/Foreign/g; s/Fort Belvoir//g; 
s/Fort Bliss//g; s/Fort Collins//g; s/Fort Huachuca//g; s/Fort Knox//g; s/Fort Lauder\...//g; s/Fort Leaven\...//g; s/Fort Mill//g; s/Fort Monmouth//g; 
s/Fort Monroe//g; s/Fort Myers//g; s/Fort Pierce//g; s/Fort Walton\...//g; s/Fort Washin\...//g; s/Fort Wayne//g; s/Fort Worth//g; 
s/Fountain Va\...//g; s/Framingham//g; s/Franklin//g; s/Frankfort//g; s/Fredericksburg//g; s/Frederick//g; s/Fremont//g; s/Fredericksburg//g; 
s/Fresno//g; s/Front Royal//g; s/Ft Mitchell//g; s/Ft Worth//g; s/Ft Wright//g; s/Fullerton//g; s/Fulton//g; s/Gainesville//g; s/Gaithersburg//g; 
...
s/Lansdowne//g; s/Lansing//g; s/Lantana//g; s/Las Vegas//g; s/Mount Laurel//g; s/Lansdale//g; s/Laurel//g; s/Lawrenceville//g; s/Lawndale//g; 
s/Layton//g; s/League City//g; s/LEARNING/Learning/g; s/Leavenworth//g; s/Leawood//g; s/Lebanon//g; s/Leesburg//g; s/legal/Legal/g; 
s/lending/Lending/g; s/Leonardtown//g; s/Leonia//g; s/Lewisburg//g; s/Lexington Park//g; s/Lexington//g; s/Libertyville//g; s/Linesville//g; 
s/Linthicum//g; s/Linwood//g; s/Litchfield \...//g; s/Lithonia//g; s/Lititz//g; s/Little Rock//g; s/Littleton//g; s/Livermore//g; s/Liverpool//g; 
s/Livonia//g; s/Llc/LLC/g; s/Lockport//g; s/Logansport//g; s/Lomita//g; s/Lompoc//g; s/Longmont//g; s/New London//g; s/London//g; s/Lone Tree//g; 
s/Long Beach//g; s/Long Valley//g; s/Lorton//g; s/Los Angeles//g; s/Louisville//g; s/Loveland//g; s/Loves Park//g; s/Lovettsville//g; s/Lufkin//g; 
s/Lumberton//g; s/Lusby//g; s/Lutherville//g; s/Lvl/Level/g; s/Lyndhurst//g; s/Lynnwood//g; s/Machias//g; s/Mahwah//g; s/Maineville//g; s/Maine//g; 
...
s/Milford//g; s/Millburn//g; s/Millersville//g; s/Millstone T\...//g; s/Milpitas//g; s/Milwaukee//g; s/Minneapolis//g; s/Minnetonka//g; s/Mishawaka//g; 
...
s/Northeast//g; s/Northfield//g; s/Northville//g; s/Norwalk//g; s/Nottingham//g; s/Novato//g; s/Nsa/NSA/g; s/Nso/NSO/g; s/NSW//g; s/Nutley//g; 
...
s/Seattle//g; s/Sebring//g; s/Secaucus//g; s/Seminole//g; s/\/Senior/, Senior/g; s/senior/Senior/g; s/SerVices/Services/g; s/Severn //g; 
...
s/South Ozone\...//g; s/South Plain\...//g; s/South River//g; s/Southborough//g; s/Southeast Asia//g; s/Southampton//g; s/Southlake//g; s/Southwest//g; 
s/spain/Spain/g; s/Spotsylvania//g; s/Spring City//g; s/Springfield//g; s/Square//g; s/Sql/SQL/g; s/St Augustine//g; s/St Charles//g; 
...
s/Sudbury//g; s/Sugar Land//g; s/Suffolk//g; s/Sugar Grove//g; s/Summerville//g; s/Summit//g; s/Sunnyvale//g; s/Superior//g; s/Suwanee//g; s/sv\...//g; 
s/Swainsboro//g; s/Swarthmore//g; s/Sykesville//g; s/Syracuse//g; s/Takoma Park//g; s/Tacoma//g; s/Tallahassee//g; s/Tall Timbers//g; s/Tampa//g; 
s/Taneytown//g; s/Tarzana//g; s/teacher/Teacher/g; s/TEAM/Team/g; s/Teaneck//g; s/technical/Technical/g; s/technology/Technology/g; s/Telluride//g; 
s/Tempe //g; s/Tenafly//g; s/TEST/Test/g; s/Thorndale//g; s/Thousand Oaks//g; s/Tipp City//g; s/Tipton//g; s/Titusville//g; s/Toledo//g; s/Topeka//g; 
s/Tornado//g; s/Toronto//g; s/Torrance//g; s/Township Of\...//g; s/Towson//g; s/trainer/Trainer/g; s/treasury/Treasury/g; s/Trenton//g; s/Tucson//g; 
s/Tulsa//g; s/Twin Falls//g; s/Twinsburg//g; s/Tyngsboro//g; s/UK//g; s/U.S.//g; s/UNDERWRITER/Underwriter/g; s/Union Ban//g; s/Union City//g; 
