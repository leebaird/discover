...
s/Charleston//g; s/Charlottesvle//g; s/Charlotte//g; s/Chattanooga//g; s/Chelmsford//g; s/Cherry Hill//g; s/Chesapeake//g; s/Cheyenne//g; s/Chicago//g; s/Christiansburg//g; 
s/Chula Vista//g; 
