...
egrep -iv '(abc|bing_ip|bing_linkedin|credentials-credentials|dev_diver|github_users|ipinfo|ipstack|mailtester|mangle|migrate_contacts|migrate_hosts|netblocks|pwnedlist|scylla|ssl_san|ssltools|virustotal)' tmp > tmp2
