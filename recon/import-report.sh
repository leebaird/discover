    ...
    if [ -f "$src/css/modern.css" ]; then
        ...
        if [ -f "$report/pages/subdomains.htm" ]; then
            sed -i \
                ...
                -e 's|inc-host-scan\.js?v=[0-9]*|inc-host-scan.js?v=42|g' \
...
need = [
    ("inc-subdomains-filter.js", '<script src="../assets/javascript/inc-subdomains-filter.js?v=20"></script>'),
    ...
    ("inc-host-scan.js", '<script src="../assets/javascript/inc-host-scan.js?v=42"></script>'),
]
