...
def write_subdomains_active_page(report_dir: str) -> dict:
    ...
    out.extend(
        [
            ...
            '<script src="../assets/javascript/inc-subdomains-filter.js?v=22"></script>',
            ...
            '<script src="../assets/javascript/inc-subdomains-ports.js?v=12"></script>',
            '<script src="../assets/javascript/inc-host-scan.js?v=75"></script>',
            "</body>",
            "</html>",
            "",
        ]
