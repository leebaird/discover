...
case "$CHOICE" in
    ...
    OUTPUT_FILE="$HOME/data/burp-$(date +%H:%M).csv"
    mv burp.csv "$OUTPUT_FILE"
    ...
    OUTPUT_FILE="$HOME/data/nexpose-$(date +%H:%M).csv"
    mv nexpose.csv "$OUTPUT_FILE"
    ...
    OUTPUT_FILE="$HOME/data/nmap-$(date +%H:%M).csv"
    mv nmap.csv "$OUTPUT_FILE"
    rm nmap.xml
    ...
    OUTPUT_FILE="$HOME/data/qualys-$(date +%H:%M).csv"
    mv qualys.csv "$OUTPUT_FILE"
