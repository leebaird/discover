...
EOF
    ...
    echo -e "\n${BLUE}[*] API path scanning completed${NC}"
...
EOF
    ...
    echo -e "\n${BLUE}[*] CORS testing completed. Found $CORS_VULNS vulnerabilities.${NC}"
...
EOF
    ...
    echo -e "${GREEN}[+] API scan completed. Results saved to $OUTPUT_DIR/api_scanner/${NC}"
